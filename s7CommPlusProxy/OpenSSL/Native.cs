...
namespace OpenSsl {
    ...
    public class Native {
        ...
        [DllImport(SSLDLLNAME, CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr SSL_CTX_use_certificate_file(IntPtr ssl, string path, int type);

        [DllImport(SSLDLLNAME, CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr SSL_CTX_use_PrivateKey_file(IntPtr ssl, string path, int type);
